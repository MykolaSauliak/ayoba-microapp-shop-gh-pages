  ...
  async init(store) {
    ...
    this.configure(
      ...
      notification => {
        ...
        // let showHours = getShowHours(type, this._store.getState()) || 21
        // let lastShowTs = getLastShowTs(type, this._store.getState())
        // this._store.dispatch(addNotification(type, notification))
        // let oneDay = 86400000 // in milliseconds
        // if(!lastShowTs || (lastShowTs < (Date.now() - oneDay))){
        //     PushNotification.localNotificationSchedule({
        //       //... You can use all the options from localNotifications
        //       bigText: notification.title,
        //       subText: notification.subtitle,
        //       date: new Date(moment().hour(showHours).millisecond()), // in 60 secs
        //     });
        //     try{
